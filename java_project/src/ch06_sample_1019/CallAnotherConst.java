...
class Person{
	...
	Person returnItSelf() {
		return this; // 클래스 형이 (Person) 인 참조형 변수를 가리킨다. : this 가.
	}
...
public class CallAnotherConst {
	...
	public static void main(String[] args) {
		...
		//String p2 = noName.returnItSelf(); // 타입 미스매치로 에러남.

		// 만약, 해당 형이 아닌 다른 형으로 받는 방법은 없을까?
		// 있음. 가장 큰 형인 최상위 클래스라고함 . Object
		// Object로 받을 수 이쏙, 원래의 형으로 되돌릴수도 있습니다.
		// 형변을 통해서.
		
		Object p3 = noName.returnItSelf(); // Object 는 그릇이 가장 큼.
		Person p4 = (Person)p3;
		
		
		// ctrl 누른 상태에서 , 해당 메서드 명을 클릭하면, 메서드가 정의한 곳으로 간다.
