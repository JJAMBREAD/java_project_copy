...
//		public abstract void showLevelMessage();
		...
		player.play(3);
		UltraLevel uLeve1 = new UltraLevel();
		player.upgradeLevel(uLeve1);
		player.play(4);
		SpecialMove specialMove = new SpecialMove("울트라스킬", 5, "전역범위");
		player.userSpecialMove(specialMove);
	}
}
